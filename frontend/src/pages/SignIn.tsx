        ...
        <div className="bg-[#0B1220] text-white h-screen overflow-y-auto overflow-x-hidden font-sans selection:bg-primary/30 selection:text-white flex flex-col px-4">
            ...
            >
                ...
                <div className="text-center mb-4">
                    ...
                    <p className="text-sm text-neutral-400">Sign in to access your AI-NIDS dashboard</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-center">
                            <input 
                                ...
                                name="remember-me" 
                                type="checkbox" 
                                className="h-4 w-4 rounded border-white/10 bg-black/20 text-primary focus:ring-primary/50 focus:ring-offset-0" 
                            />
